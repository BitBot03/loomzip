...
export default function RecordModal({ collection, record, tabId, onClose }: RecordModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[80] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 motion-modal-overlay" onMouseDown={(e) => { if (e.target === e.currentTarget) onClose(); }}>
